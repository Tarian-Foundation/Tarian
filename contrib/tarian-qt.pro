...
RESOURCES += src/qt/tarian.qrc src/qt/tarian_locale.qrc

TRANSLATIONS += src/qt/locale/tarian_bg.ts \
                src/qt/locale/tarian_de.ts \
                src/qt/locale/tarian_en.ts \
                src/qt/locale/tarian_es.ts \
                src/qt/locale/tarian_fi.ts \
                src/qt/locale/tarian_fr.ts \
                src/qt/locale/tarian_it.ts \
                src/qt/locale/tarian_ja.ts \
                src/qt/locale/tarian_pl.ts \
                src/qt/locale/tarian_pt.ts \
                src/qt/locale/tarian_ru.ts \
                src/qt/locale/tarian_sk.ts \
                src/qt/locale/tarian_sv.ts \
                src/qt/locale/tarian_vi.ts \
                src/qt/locale/tarian_zh_CN.ts \
                src/qt/locale/tarian_zh_TW.ts
