...
def setup_repos():
    ...
    if not os.path.isdir('tarian-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Carbon-Reduction-Initiative/TARN-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('tarian'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Carbon-Reduction-Initiative/TARN.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/Carbon-Reduction-Initiative/TARN', help='Specify the URL of the repository. Default is %(default)s')
