...
#include "qt/tarian/defaultdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            TARIANGUI* window = static_cast<TARIANGUI*>(parentWidget());
...
{
    TARIANGUI* gui = static_cast<TARIANGUI*>(parentWidget());
...
{
    hide();
    static_cast<TARIANGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("TARIAN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your TARNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
