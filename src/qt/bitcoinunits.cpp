...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TARN);
    unitlist.append(mTARN);
    unitlist.append(uTARN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case TARN:
        return QString("tarian");
    case mTARN:
        return QString("mtarian");
    case uTARN:
        return QString::fromUtf8("utarian");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZtarn)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZTARN)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZTARN);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZTARN)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZTARN));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
