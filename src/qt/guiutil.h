...
/** Utility functions used by the TARIAN Qt UI.
 */
namespace GUIUtil
{
...
// Render TARIAN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZtarn = false);
...
// Parse "tarian:" URI into recipient object, return true on successful parsing
