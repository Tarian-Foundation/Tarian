...
#include "qt/tarian/topbar.h"
#include "qt/tarian/forms/ui_topbar.h"
#include "qt/tarian/lockunlock.h"
#include "qt/tarian/qtutils.h"
#include "qt/tarian/receivedialog.h"
#include "qt/tarian/loadingdialog.h"
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopTarn}, "amount-small-topbar");
    setCssProperty({ui->labelAmountTarn}, "amount-topbar");
    setCssProperty({ui->labelPendingTarn, ui->labelImmatureTarn}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // TARN Total
    QString totalTarn = GUIUtil::formatBalance(balance, nDisplayUnit);

    // TARN
    // Top
    ui->labelAmountTopTarn->setText(totalTarn);
    // Expanded
    ui->labelAmountTarn->setText(totalTarn);
    ui->labelPendingTarn->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureTarn->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
