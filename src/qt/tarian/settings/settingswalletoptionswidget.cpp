...
#include "qt/tarian/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/tarian/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TARIANGUI* _window, QWidget *parent) :
