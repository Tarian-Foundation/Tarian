...
#include "qt/tarian/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/tarian/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TARIANGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TARIAN RPC console.") + "<br>" +
