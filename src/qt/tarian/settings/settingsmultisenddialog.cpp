...
#include "qt/tarian/settings/settingsmultisenddialog.h"
#include "qt/tarian/settings/forms/ui_settingsmultisenddialog.h"
#include <QListView>
    ...
    ui(new Ui::SettingsMultisendDialog)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText("Tarian address or contact label");
