...
#include "qt/tarian/settings/settingsnetworkwidget.h"
#include "qt/tarian/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tarian/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TARIANGUI* _window, QWidget *parent) :
