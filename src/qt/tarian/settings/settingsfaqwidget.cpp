...
#include "qt/tarian/settings/settingsfaqwidget.h"
#include "qt/tarian/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableTARN,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableTARN,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableTARN,
    ...
    connect(ui->pushButton_UnspendableTARN, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableTARN);});
