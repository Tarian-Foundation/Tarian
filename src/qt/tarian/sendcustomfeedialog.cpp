...
#include "qt/tarian/sendcustomfeedialog.h"
#include "qt/tarian/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(TARIANGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &TARIANGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
