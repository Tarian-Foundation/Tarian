...
extern UniValue setztarnseed(const UniValue& params, bool fHelp);
extern UniValue getztarnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztarn(const UniValue& params, bool fHelp);
extern UniValue dztarnstate(const UniValue& params, bool fHelp);
