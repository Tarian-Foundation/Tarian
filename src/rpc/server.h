...
extern UniValue setztarnseed(             const JSONRPCRequest& request);
extern UniValue getztarnseed(             const JSONRPCRequest& request);
extern UniValue generatemintlist(         const JSONRPCRequest& request);
extern UniValue searchdztarn(             const JSONRPCRequest& request);
extern UniValue dztarnstate(              const JSONRPCRequest& request);
