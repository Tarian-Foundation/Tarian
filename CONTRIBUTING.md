Contributing to Tarian Core
============================

The Tarian Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Carbon-Reduction-Initiative/TARN/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Tarian Core project, and is not to be
confused with overall TARN Network Protocol consensus changes.

Whether a pull request is merged into Tarian Core rests with the project merge
...
Patches that change TARN consensus rules are considerably more involved than
...
Where a patchset proposes to change the TARN consensus, it must have been
...
The project leader is the release manager for each Tarian Core release.
