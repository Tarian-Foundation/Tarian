...
The build script we'll be using is contained in the TARIAN github repository ([contrib/gitian-build.py](https://github.com/Tarian-Foundation/Tarian/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the TARIAN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Tarian-Foundation/Tarian/master/contrib/gitian-build.py
