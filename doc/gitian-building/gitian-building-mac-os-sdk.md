...
The script [extract-osx-sdk.sh](https://github.com/Carbon-Reduction-Initiative/TARN/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
tarian/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Carbon-Reduction-Initiative/TARN/blob/master/doc/README_osx.md) for troubleshooting tips.