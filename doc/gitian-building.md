...
```bash
gpg --output ${VERSION}-linux/${NAME}/tarian-linux-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-linux/$NAME/tarian-linux-${VERSION%\.*}-build.assert
gpg --output ${VERSION}-osx-unsigned/$NAME/tarian-osx-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-osx-unsigned/$NAME/tarian-osx-${VERSION%\.*}-build.assert
gpg --output ${VERSION}-win-unsigned/$NAME/tarian-win-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-win-unsigned/$NAME/tarian-win-${VERSION%\.*}-build.assert
```
...
You can also mail the files to Fuzzbawls (fuzzbawls@tarian.org) and he will commit them.

```bash
gpg --detach-sign ${VERSION}-linux/${NAME}/tarian-linux-*-build.assert
gpg --detach-sign ${VERSION}-win-unsigned/${NAME}/tarian-win-*-build.assert
gpg --detach-sign ${VERSION}-osx-unsigned/${NAME}/tarian-osx-*-build.assert
```
