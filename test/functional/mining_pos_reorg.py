...
class ReorgStakeTest(TarnTestFramework):
    ...
    def run_test(self):
        ...
        # Check TARN and zTARN supply at the beginning
        # ------------------------------------------
        # zTARN supply: 2 coins for each denomination
        expected_ztarn_supply = {
            "1": 2,
            "5": 10,
            "10": 20,
            "50": 100,
        ...
        # TARN supply: block rewards minus burned fees for minting
        expected_money_supply = 250.0 * 330 - 16 * 0.01
        self.check_money_supply(expected_money_supply, expected_ztarn_supply)
        ...
        # Verify that TARN and zTARN supplies were properly updated after the spends and reorgs
        self.log.info("Check TARN and zTARN supply...")
        ...
        expected_ztarn_supply[str(spent_coin_0)] -= spent_coin_0
        expected_ztarn_supply[str(spent_coin_1)] -= spent_coin_1
        expected_ztarn_supply["total"] -= (spent_coin_0 + spent_coin_1)
        self.check_money_supply(expected_money_supply, expected_ztarn_supply)
